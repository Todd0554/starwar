...
RSpec.describe "characters/index" do
  it "displays star wars characters on index page" do
    assign(:characters, [
      {
        "id": 1,
        "name": 'Luke Skywalker',
    ...
    expect(rendered).to match(/Star Wars Characters/)
    expect(rendered).to match(/Obi-Wan Kenobi/)
    expect(rendered).to match(/C-3PO/)
